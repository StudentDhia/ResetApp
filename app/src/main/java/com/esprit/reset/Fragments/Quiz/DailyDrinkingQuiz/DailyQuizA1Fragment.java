 ...
 */
public class DailyQuizA1Fragment extends Fragment {


    public DailyQuizA1Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_daily_quiz_a1, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        r1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((MainActivity)getActivity()).replaceFragment(new DailyQuizA2Fragment());
            }
        });
    ...
    public void setData(){
        final String ServerURL = LoginActivity.ServerAddress+"reset/webservices/DailyQuizA1.php";
