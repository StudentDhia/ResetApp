...
public class DailyQuizS4Fragment extends Fragment {
    ...
    public void setData(){
        final String ServerURL = LoginActivity.ServerAddress+"reset/webservices/DailyQuizS4.php";
        final String TAG = "DailyQuizS4Fragment";
        String REQUEST_TAG = "com.androidtutorialpoint.volleyJsonObjectRequest";

        // Request parameters to be send with post request
        StringRequest postRequest = new StringRequest(Request.Method.GET, ServerURL+"?id="+LoginActivity.token+"&cigaretteNumber="+mParam1+"&cigarettePrice="+mParam2, // the request body, which is a JsonObject otherwise null
