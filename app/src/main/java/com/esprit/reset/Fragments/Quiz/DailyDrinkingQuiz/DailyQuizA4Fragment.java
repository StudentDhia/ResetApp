...
*/
    ...
    public void setData(){
        final String ServerURL = LoginActivity.ServerAddress+"reset/webservices/DailyQuizA4.php";
        final String TAG = "DailyQuizA4Fragment";
        String REQUEST_TAG = "com.androidtutorialpoint.volleyJsonObjectRequest";

        // Request parameters to be send with post request
        StringRequest postRequest = new StringRequest(Request.Method.GET, ServerURL+"?id="+LoginActivity.token+"&drinkNumber="+mParam1+"&drinkPrice="+mParam2, // the request body, which is a JsonObject otherwise null
